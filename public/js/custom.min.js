...
function addUser(){
    ...
    swalWithBootstrapButtons({
        ...
        '                                    <button type="submit" class="btn btn-success" name="submit" value="newUser"><i class="fa fa-check"></i></button></form>',
...
function changeRole(id){
    ...
    $.each(roles, function (key, value){
        roleSelect = roleSelect + '<option onclick="saveRole('+value+','+id+')">' + value + '</option>'
    })
